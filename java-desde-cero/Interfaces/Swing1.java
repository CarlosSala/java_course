...
public class Swing1 extends JFrame implements ActionListener, ItemListener, ChangeListener {
    ...
    public Swing1() {
        ...
        label1.setBounds(200, 10, 200, 400);
        add(label1);

        label2 = new JLabel("version 1.0");
        label2.setBounds(200, 80, 200, 200);
        add(label2);
        ...
        textField1.setBounds(110, 17, 150, 20);
        add(textField1);

        boton5 = new JButton("Aceptar");
        boton5.setBounds(110, 50, 100, 30);
        add(boton5);
        boton5.addActionListener(this);

        textField2 = new JTextField();
        textField2.setBounds(10, 280, 200, 30);
        add(textField2);

        textArea1 = new JTextArea();
        scrollPane1 = new JScrollPane(textArea1);
        scrollPane1.setBounds(10, 320, 200, 100);
        add(scrollPane1);

        boton6 = new JButton("Agregar");
        boton6.setBounds(220, 280, 90, 30);
        add(boton6);
        ...
        radio2.setBounds(450, 350, 100, 30);
        ...
        radio3.setBounds(450, 400, 100, 30);

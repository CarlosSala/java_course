...
public class ProyectoFinal1 extends JFrame implements ActionListener, ChangeListener {
    ...
    public ProyectoFinal1(){
        ...
        ProyectoFinal primeraIntefaz =new ProyectoFinal();
        nombre = primeraIntefaz.texto;
    ...
    public void actionPerformed(ActionEvent evento){
        if(evento.getSource() == button1){
            ...
            ProyectoFinal Bienvenido = new ProyectoFinal();
    ...
    public static void main(String args[]){
        ProyectoFinal1 licencia = new ProyectoFinal1();

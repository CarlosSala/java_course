/* modificadores de acceso:
 ...
 -protected: solo entre clases del mismo paquete pueden accederse,
 ademas cuando se utiliza la herencia independiente de si las
 clases pertenecen al mismo paquete o no
